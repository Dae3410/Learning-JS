...
for(let i = 0; i < names.length; i++){
    // console.log()
     nameLengths.push(names[i].lenghts);
...
let GroceryStore1 = [10, 5, 17];
let GroceryStore2 = [16, 2, 12];

function twoAverages(array1, array2){
     
     let total1 = array1.reduce ((sum, value) => sum + value, 0);
     let total2 = array2.reduce((sum, value) => sum + value, 0);
